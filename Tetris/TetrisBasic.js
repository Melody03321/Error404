...
function SetupCanvas(){
    ...
    ctx.fillText("OBJECTIF:404pts", 290, 50);
    ...
    // Draw controls text
    ctx.font = '19px Arial';
    ctx.fillText("Q : Move Left", 310, 388);
    ctx.fillText("D : Move Right", 310, 413);
    ctx.fillText("S : Move Down", 310, 438);
    ctx.fillText("Z : Rotate Right", 310, 463);
...
function HandleKeyPress(key){
    ...
    if(winOrLose != "Game Over"){
        ...
        // s keycode (DOWN for AZERTY)
        else if(key.keyCode === 83){
            MoveTetrominoDown();
        } 
        // e keycode (ROTATE for AZERTY)
